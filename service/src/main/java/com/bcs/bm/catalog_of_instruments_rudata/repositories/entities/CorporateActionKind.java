...
@Data
@NoArgsConstructor
@Document(collection = "corporate_action_kinds")
@PrimaryKeyId({"code"})
public class CorporateActionKind implements DefaultEntity {
    ...
    public CorporateActionKind(String id, String clazz, LocalDateTime importtime) {
        this.id = id;
        this.clazz = clazz;
