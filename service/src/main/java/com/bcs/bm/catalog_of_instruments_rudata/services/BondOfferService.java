...
@Transactional
@Service(BondOfferService.NAME)
public class BondOfferService extends AbstractRuDataService<BondOffer> {

    public static final String NAME = "bondoffer" + AbstractRuDataService.NAME;

    public BondOfferService(RepositoryFacade<Map, BondOffer> repositoryFacade,
                             JsonProcessor jsonProcessor,
                             RestTemplate restTemplate,
                             ServiceProperties serviceProperties) {
        super(repositoryFacade, serviceProperties, jsonProcessor, restTemplate, BondOffer.class);
    }
    ...
    public List<BondOffer> upload(Token token) {
        try {
            ...
            final URI uri = new URI(serviceProperties.getRuData().getUrl() + "/Bond/Offers");
            ...
            final List<BondOffer> result = repositoryFacade.upsert(clazz, jsonProcessor.apply((List<Map<String, Object>>) response.getBody()), LocalDateTime.now(ZoneOffset.UTC));
            return result;
        } finally {
