/*
 * CorporateActionKindService.java
 *
...
@Transactional
@Service(CorporateActionKindService.NAME)
public class CorporateActionKindService extends AbstractRuDataService<CorporateActionKind> {

    public static final String NAME = "corporateactionkind" + AbstractRuDataService.NAME;

    public CorporateActionKindService(RepositoryFacade<Map, CorporateActionKind> repositoryFacade,
                                      JsonProcessor jsonProcessor,
                                      RestTemplate restTemplate,
                                      ServiceProperties serviceProperties) {
        super(repositoryFacade, serviceProperties, jsonProcessor, restTemplate, CorporateActionKind.class);
    }
    ...
    public List<CorporateActionKind> upload(Token token) {
        try {
            ...
            final URI uri = new URI(serviceProperties.getRuData().getUrl() + "/CorporateAction/Kinds");
            ...
            final List<CorporateActionKind> result = repositoryFacade.upsert(clazz, jsonProcessor.apply((List<Map<String, Object>>) response.getBody()), LocalDateTime.now(ZoneOffset.UTC));
            return result;
        } finally {
